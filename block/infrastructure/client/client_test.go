...
func TestUploadToBlob(t *testing.T) {
	tests := []struct {
		document string
		url      string
		key      string
	...
	for _, test := range tests {
		...
		err := c.UploadToBlob(test.document, test.url, test.key, test.name)
