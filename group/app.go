...
import (
	...
	h "github.com/bruno5200/CSM/group/infrastructure/handler"
	r "github.com/bruno5200/CSM/group/infrastructure/repository"
	"github.com/bruno5200/CSM/group/router"
...
func main() {
	...
	router.GroupRouter(app, h.NewGroupHandler(a.NewGroupService(r.NewGroupRepository(db.PostgresDB()), mc)))
